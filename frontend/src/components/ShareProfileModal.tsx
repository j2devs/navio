    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 w-full max-w-sm mx-4 relative shadow-2xl">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="w-10 h-10 bg-gradient-to-r from-violet-500 to-cyan-400 rounded-lg flex items-center justify-center">
        ...
        {/* Toast Notification */}
        {showToast && (
          <div className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-violet-500 to-cyan-400 text-white px-6 py-3 rounded-xl shadow-lg z-[60] animate-bounce font-semibold">
