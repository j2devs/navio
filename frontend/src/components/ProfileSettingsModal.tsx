    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 w-full max-w-md mx-4 relative shadow-2xl">
        ...
        <div className="mb-6">
          ...
          <div className="text-lg font-semibold text-slate-800 bg-gradient-to-r from-violet-100 to-cyan-100 p-3 rounded-xl">
            testeruser
          </div>
        </div>
        ...
        <div className="flex justify-between items-center mb-6">
          <button className="px-6 py-3 bg-gradient-to-r from-violet-500 to-cyan-400 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105 shadow-lg">
            Save settings
          </button>
          <button
